...
class BranchController: UIViewController {
    ...
    @IBAction private func searchCityButton(_ sender: UIBarButtonItem) {
        createAlert()
    }
...
extension BranchController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CellForBranch", for: indexPath)
            as? CellForBranch else { return UITableViewCell() }
